...
import type { ModelOptionProvider, ModelOptionsResponse, PinnedModelRef } from '@/types/hermes'
...
export function ModelMenuPanel({ gateway, onSelectModel, profile = 'default', requestGateway }: ModelMenuPanelProps) {
  ...
  const groups = useMemo(
    ...
    [pickerProviders, search, optionsModel, optionsProvider, effectiveVisibleModels, modelOptions.data?.pinned_models]
  )
