...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    "anthropic": [
        # Fork curation: claude-sonnet-5 leads (Owner's default Anthropic model).
        "claude-sonnet-5",
    ...
    "opencode-zen": [
        ...
        # Fork curation: the Owner's trimmed opencode-zen catalog stands;
        # upstream's expanded list is deliberately not imported here.
        "gpt-5.6-luna",
        ...
        "glm-5.3", "glm-5.3-flash", "glm-5.2", "glm-5.1", "glm-5", "kimi-k2.7-code",
        "deepseek-v4-pro", "deepseek-v4-flash", "deepseek-v4-flash-free",
        "qwen3.6-plus", "qwen3.5-plus", "big-pickle", "mimo-v2.5-free",
    ...
    "opencode-go": [
        # Fork curation: gpt-5.6-luna leads the Go catalog (Owner's default).
        "gpt-5.6-luna",
        "kimi-k3", "kimi-k2.7-code", "kimi-k2.6", "kimi-k2.5", "grok-4.5", "glm-5.3",
