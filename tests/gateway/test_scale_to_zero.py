...
def test_suspend_self_posts_suspend_for_this_machine(tmp_path_factory):
    captured: list[bytes] = []
    sock_path, t = _fake_flaps(tmp_path_factory.mktemp("flaps"), "200 OK", captured)
...
def test_suspend_self_non_2xx_is_false_not_raise(tmp_path_factory):
    captured: list[bytes] = []
    sock_path, t = _fake_flaps(tmp_path_factory.mktemp("flaps"), "412 Precondition Failed", captured)
