...
def test_background_review_installs_thread_local_candidate_only_whitelist():
    ...
    # Fork hardening: background review is candidate-ledger only — the
    # default whitelist is EMPTY (no memory/skills/file tools). Upstream's
    # extra_tools config opt-in is covered by
    # test_background_review_whitelist_includes_configured_extra_tools.
